...
using RealEstateApp.Sessions;
using RealEstateApp.Web.Models.Account;
using RealEstateApp.Web.Views.Shared.Components.TenantChange;

namespace RealEstateApp.Web.Controllers
{
    public class AccountController : RealEstateAppControllerBase
    {
